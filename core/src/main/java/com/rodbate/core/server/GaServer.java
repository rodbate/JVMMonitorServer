...
import com.rodbate.core.ClassDataSource;
import com.rodbate.core.Configure;
import com.rodbate.core.manager.ReflectManager;
...
import static com.rodbate.core.server.LineDecodeState.READ_CHAR;
import static com.rodbate.core.server.LineDecodeState.READ_EOL;
...
public class GaServer {
    ...
    private SocketChannel acceptSocketChannel(Selector selector, ServerSocketChannel serverSocketChannel, Configure configure) throws IOException {
        ...
        if (!session.isSilent()) {
            // 这里输出Logo
            writeToSocketChannel(socketChannel, session.getCharset(), GaStringUtils.getLogo());
