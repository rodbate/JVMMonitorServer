...
import com.rodbate.core.util.matcher.*;
...
public class JavaScriptCommand implements ScriptSupportCommand, Command {
    ...
    private void loadJavaScriptSupport(Compilable compilable) throws IOException, ScriptException {
        ...
        compilable.compile(
                IOUtils.toString(
                        GaStringUtils.class.getResourceAsStream("/com/rodbate/core/res/javascript/gblocking.js"),
    ...
    private void loadGreysModule(Compilable compilable) throws IOException, ScriptException {
        ...
        compilable.compile(
                IOUtils.toString(
                        GaStringUtils.class.getResourceAsStream("/com/rodbate/core/res/javascript/greys-module.js"),
                        Charset.forName("UTF-8")
                )
        ).eval();
    }
        ...
        try {
            ...
            return new SilentAction() {
                ...
                public void action(Session session, Instrumentation inst, Printer printer) throws Throwable {
                    printer.println("javascript compile failed. because " + GaStringUtils.getCauseMessage(e)).finish();
                }
            };
            ...
            return new SilentAction() {
                @Override
                public void action(Session session, Instrumentation inst, Printer printer) throws Throwable {
                    printer.println("javascript function not defined. because " + GaStringUtils.getCauseMessage(e)).finish();
                }
            };
            ...
            return new SilentAction() {
                @Override
                public void action(Session session, Instrumentation inst, Printer printer) throws Throwable {
                    printer.println("load javascript failed. because " + GaStringUtils.getCauseMessage(e)).finish();
                }
            };
        }
