...
import com.rodbate.core.advisor.*;
...
import com.rodbate.core.textui.TTree;
                        ...
                        return new ReflectAdviceTracingListenerAdapter<ProcessContext, TraceInnerContext>() {
                            ...
                            public void invokeBeforeTracing(
                                ...
                                if (null == tracingLineNumber) {
                                    entity.tTree.begin(GaStringUtils.tranClassName(tracingClassName) + ":" + tracingMethodName + "()");
                                } else {
                                    entity.tTree.begin(GaStringUtils.tranClassName(tracingClassName) + ":" + tracingMethodName + "(@" + tracingLineNumber + ")");
                                }
                            ...
                            public void before(Advice advice, ProcessContext processContext, TraceInnerContext innerContext) throws Throwable {
                                ...
                                entity.tTree = new TTree(true, "Tracing for : " + GaStringUtils.getThreadInfo())
