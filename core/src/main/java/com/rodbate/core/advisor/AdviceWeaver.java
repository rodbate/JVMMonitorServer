...
import com.rodbate.core.util.AsmCodeLock;
import com.rodbate.core.util.CodeLock;
...
import com.rodbate.core.util.collection.ThreadUnsafeFixGaStack;
import com.rodbate.core.util.collection.ThreadUnsafeGaStack;
...
import static com.rodbate.core.util.GaCheckUtils.isEquals;
        ...
        return new AdviceAdapter(ASM5, new JSRInlinerAdapter(mv, access, name, desc, signature, exceptions), access, name, desc) {
            ...
            private void loadClassLoader() {
                ...
                if (this.isStaticMethod()) {
                    visitLdcInsn(GaStringUtils.tranClassName(className));
