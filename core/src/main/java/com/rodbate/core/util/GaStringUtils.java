...
public class GaStringUtils {
    ...
    public static String getLogo() throws IOException {
        final String logo = IOUtils.toString(GaStringUtils.class.getResourceAsStream("/com/rodbate/core/res/logo.txt"));
        final String version = IOUtils.toString(GaStringUtils.class.getResourceAsStream("/com/rodbate/core/res/version"));
