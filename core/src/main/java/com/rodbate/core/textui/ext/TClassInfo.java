package com.rodbate.core.textui.ext;


import com.rodbate.core.textui.TComponent;
import com.rodbate.core.textui.TKv;
import com.rodbate.core.textui.TLadder;
...
public class TClassInfo implements TComponent {
    ...
    private String drawClassInfo() {
        ...
        final TTable tTable = new TTable(new TTable.ColumnDefine[]{
                ...
                .addRow("class-info", GaStringUtils.tranClassName(clazz))
                .addRow("code-source", getCodeSource(cs))
                .addRow("name", GaStringUtils.tranClassName(clazz))
                ...
                .addRow("modifier", GaStringUtils.tranModifier(clazz.getModifiers()))
        ...
        if (null != fields
            ...
            for (Field field : fields) {
                ...
                final TKv kvView = new TKv(new TTable.ColumnDefine(TTable.Align.RIGHT), new TTable.ColumnDefine(50, false, TTable.Align.LEFT))
                        .add("modifier", GaStringUtils.tranModifier(field.getModifiers()))
                        .add("type", GaStringUtils.tranClassName(field.getType()))
                ...
                if (null != annotationArray && annotationArray.length > 0) {
                    for (Annotation annotation : annotationArray) {
                        annotationSB.append(GaStringUtils.tranClassName(annotation.annotationType())).append(",");
                    }
                ...
                if (Modifier.isStatic(field.getModifiers())) {
                    ...
                    try {
                        ...
                        kvView.add("value", GaStringUtils.newString(field.get(null)));
    ...
    private String drawSuperClass() {
        ...
        if (null != superClass) {
            tLadder.addItem(GaStringUtils.tranClassName(superClass));
            while (true) {
