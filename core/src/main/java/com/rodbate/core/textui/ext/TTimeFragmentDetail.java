...
import com.rodbate.core.util.SimpleDateFormatHolder;
import com.rodbate.core.util.SizeOf;

import java.io.PrintWriter;
import java.io.StringWriter;
import java.lang.instrument.Instrumentation;

import static com.rodbate.core.textui.TTable.Align.*;
    ...
    public String rendering() {
        ...
        final TTable tTable = new TTable(
                new TTable.ColumnDefine[]{
                        new TTable.ColumnDefine(15, false, RIGHT),
                        new TTable.ColumnDefine(150, false, LEFT)
                })
                .padding(1)
